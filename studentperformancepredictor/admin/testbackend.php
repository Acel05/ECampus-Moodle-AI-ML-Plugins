...
// Or use batch file
echo html_writer::tag('h5', 'Alternative: Use the batch file');
echo html_writer::start_tag('pre', ['class' => 'bg-dark text-light p-3 rounded']);
echo html_writer::tag('code', 'cd ' . $CFG->dirroot . '/blocks/studentperformancepredictor' . PHP_EOL . 'start_backend.bat');
echo html_writer::end_tag('pre');
