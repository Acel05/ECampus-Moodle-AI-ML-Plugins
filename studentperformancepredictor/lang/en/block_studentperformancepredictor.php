...
// Debug tools
$string['debugtool'] = 'Debug tool';
$string['debugtoolbutton'] = 'Open debug tool';
$string['tasksandmodels'] = 'Tasks and models';
$string['runningtasks'] = 'Running tasks';
$string['pendingtasks'] = 'Pending tasks';
$string['createtesttask'] = 'Create test task';
...
$string['taskname'] = 'Task name';
$string['cleartasks'] = 'Clear failed tasks';
$string['runselectedtask'] = 'Run selected task';
$string['nopendingtasks'] = 'No pending tasks found';
$string['invalidtaskid'] = 'Invalid task ID';
$string['taskrunsuccessful'] = 'Task run successfully';
$string['taskrunfailed'] = 'Task run failed';
...
$string['apiconnectiontest'] = 'API connection test';
$string['apistatus'] = 'API status';
$string['apitestresult'] = 'API test result';
$string['apisuccess'] = 'API connection successful';
$string['apifailed'] = 'API connection failed';
$string['filesystemcheck'] = 'File system check';
$string['directorywritable'] = 'Directory writable';
